...
```shell
bazel-bin/updatable_private_set_intersection/generate_dummy_data --server_data_file=/tmp/dummy_server_data.csv \
...
```shell
bazel-bin/updatable_private_set_intersection/generate_dummy_data \
...
```shell
bazel-bin/updatable_private_set_intersection/server --server_data_file=/tmp/dummy_server_data.csv
```
...
```shell
bazel-bin/updatable_private_set_intersection/client --client_data_file=/tmp/dummy_client_data.csv
```
