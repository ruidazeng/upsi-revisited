...
int main(int argc, char** argv) {
  ...
  auto maybe_dummy_data = upsi::GenerateRandomDatabases(
  ...
  auto server_write_status = upsi::WriteServerDatasetToFile(
  ...
  auto client_write_status = upsi::WriteClientDatasetToFile(
