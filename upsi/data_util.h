...
#ifndef upsi_DATA_UTIL_H_
#define upsi_DATA_UTIL_H_
...
typedef std::pair<std::vector<std::string>, std::vector<BigNum>> PartyZeroDataset;
typedef std::vector<std::string> PartyOneDataset;
...
// read in party zero's daily datasets
...
// read in party one's daily datasets
