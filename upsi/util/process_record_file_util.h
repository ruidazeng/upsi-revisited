...
#ifndef upsi_UTIL_PROCESS_RECORD_FILE_UTIL_H_
#define upsi_UTIL_PROCESS_RECORD_FILE_UTIL_H_
...
#include "upsi/util/process_record_file_parameters.h"
#include "upsi/util/proto_util.h"
#include "upsi/util/recordio.h"
#include "upsi/util/status.inc"

namespace upsi::util::process_file_util {
...
#endif  // upsi_UTIL_PROCESS_RECORD_FILE_UTIL_H_
