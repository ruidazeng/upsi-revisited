...
#ifndef upsi_UTIL_ELGAMAL_KEY_UTIL_H_
#define upsi_UTIL_ELGAMAL_KEY_UTIL_H_
...
namespace upsi::elgamal_key_util {

// Generates a pair of public, private ElGamal keys and writes them to the
// provided files as ::upsi::ElGamalPublicKey and
// ::upsi::ElGamalPrivateKey proto messages.
...
// ::upsi::ElGamalPublicKey proto messages.
...
#endif  // upsi_UTIL_ELGAMAL_KEY_UTIL_H_
