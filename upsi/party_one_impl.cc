...
PartyOneImpl::ServerExchange(const PrivateIntersectionClientMessage::StartProtocolRequest&
                        client_message) {
...
PartyOneImpl::ServerProcessing(const PrivateIntersectionClientMessage::ClientRoundOne&
