...
StatusOr<PartyOneMessage::ServerExchange> PartyOneImpl::ServerExchange(
    ...
    PartyOneMessage::ServerExchange result;
...
Status PartyOneImpl::Handle(
    ...
    const PartyZeroMessage& client_message = request.private_intersection_client_message();
