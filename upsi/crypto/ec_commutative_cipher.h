...
#ifndef upsi_EC_COMMUTATIVE_CIPHER_H_
#define upsi_EC_COMMUTATIVE_CIPHER_H_
...
//    ::upsi::StatusOr<string> double_encrypted_string =
...
//    above.
//    ::upsi::StatusOr<string> decrypted_string =
...
//    ::upsi::StatusOr<std::pair<string, string>>
...
class ECCommutativeCipher {
 public:
  ...
  ::upsi::StatusOr<std::string> Encrypt(
  ...
  //
  // This method is not threadsafe.
  ::upsi::StatusOr<std::string> ReEncrypt(
  ...
  //
  // This method is not threadsafe.
  ::upsi::StatusOr<std::pair<std::string, std::string>>
  ...
  //
  // This method is not threadsafe.
  ::upsi::StatusOr<std::string> Decrypt(
      absl::string_view ciphertext);
  ...
  //
  // This method is not threadsafe.
  ::upsi::StatusOr<std::string> HashToTheCurve(
      absl::string_view plaintext);
 ...
 private:
  ...
  ::upsi::StatusOr<ECPoint> Encrypt(const ECPoint& point);

  // Hashes a string to a point on the elliptic curve.
  ::upsi::StatusOr<ECPoint> HashToTheCurveInternal(
      absl::string_view plaintext);
...
#endif  // upsi_EC_COMMUTATIVE_CIPHER_H_
