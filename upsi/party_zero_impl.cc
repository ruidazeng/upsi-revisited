...
Status PartyZeroImpl::ClientSendRoundOne(
  MessageSink<ClientMessage>* client_message_sink) {
    // A NEW DAY - update
    this->current_day += 1;
    ClientMessage client_message;
...
Status PartyZeroImpl::ClientExchange(
...
StatusOr<PrivateIntersectionClientMessage::ClientRoundOne> 
   PartyZeroImpl::ClientPreProcessing(std::vector<std::string> elements) {
...
Status PartyZeroImpl::ClientPostProcessing(
