...
#ifndef updatable_private_set_intersection_PROTOCOL_SERVER_H_
#define updatable_private_set_intersection_PROTOCOL_SERVER_H_
...
#endif  // updatable_private_set_intersection_PROTOCOL_SERVER_H_
