...
#ifndef updatable_private_set_intersection_INTERNAL_UTIL_PROTO_UTIL_H_
#define updatable_private_set_intersection_INTERNAL_UTIL_PROTO_UTIL_H_
...
#endif  // updatable_private_set_intersection_INTERNAL_UTIL_PROTO_UTIL_H_
