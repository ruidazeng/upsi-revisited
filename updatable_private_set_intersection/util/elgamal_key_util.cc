...
#include "updatable_private_set_intersection/util/elgamal_key_util.h"
...
#include "updatable_private_set_intersection/util/elgamal_proto_util.h"
#include "updatable_private_set_intersection/util/proto_util.h"
#include "updatable_private_set_intersection/util/recordio.h"
#include "updatable_private_set_intersection/util/status.inc"

namespace updatable_private_set_intersection::elgamal_key_util {
namespace {
using updatable_private_set_intersection::OkStatus;
using updatable_private_set_intersection::ProtoUtils;
}  // namespace
...
Status GenerateElGamalKeyPair(int curve_id, absl::string_view pub_key_filename,
  ...
  ASSIGN_OR_RETURN(auto key_pair,
                   updatable_private_set_intersection::elgamal::GenerateKeyPair(group));
  ASSIGN_OR_RETURN(
...
Status ComputeJointElGamalPublicKey(
  ...
  ASSIGN_OR_RETURN(
      auto joint_key,
      updatable_private_set_intersection::elgamal::GeneratePublicKeyFromShares(shares));
