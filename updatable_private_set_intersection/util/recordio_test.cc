...
#include "updatable_private_set_intersection/util/file_test.pb.h"
...
using ::updatable_private_set_intersection::testing::TestProto;
...
void ExpectInternalErrorWithSubstring(const Status& status,
  ...
  EXPECT_THAT(status, StatusIs(updatable_private_set_intersection::StatusCode::kInternal,
                               HasSubstr(substring)));
}
