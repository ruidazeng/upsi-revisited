...
#ifndef updatable_private_set_intersection_UTIL_ELGAMAL_PROTO_UTIL_H_
#define updatable_private_set_intersection_UTIL_ELGAMAL_PROTO_UTIL_H_
...
namespace updatable_private_set_intersection::elgamal_proto_util {

// Converts a struct elgamal::PublicKey into a protocol buffer
// ::updatable_private_set_intersection::ElGamalPublicKey.
...
// ::updatable_private_set_intersection::ElGamalSecretKey.
StatusOr<::updatable_private_set_intersection::ElGamalSecretKey> SerializePrivateKey(
    const elgamal::PrivateKey& private_key_struct);

// Converts a protocol buffer ::updatable_private_set_intersection::ElGamalSecretKey into
...
StatusOr<std::unique_ptr<elgamal::PrivateKey>> DeserializePrivateKey(
    Context* context,
    const ::updatable_private_set_intersection::ElGamalSecretKey& private_key_proto);

// Converts a struct elgamal::Ciphertext into a protocol buffer
// ::updatable_private_set_intersection::ElGamalCiphertext.
...
#endif  // updatable_private_set_intersection_UTIL_ELGAMAL_PROTO_UTIL_H_
