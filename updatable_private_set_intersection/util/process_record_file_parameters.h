...
#ifndef updatable_private_set_intersection_UTIL_PROCESS_RECORD_FILE_PARAMETERS_H_
#define updatable_private_set_intersection_UTIL_PROCESS_RECORD_FILE_PARAMETERS_H_

#include <cstddef>
#include <cstdint>

namespace updatable_private_set_intersection::util {
...
#endif  // updatable_private_set_intersection_UTIL_PROCESS_RECORD_FILE_PARAMETERS_H_
