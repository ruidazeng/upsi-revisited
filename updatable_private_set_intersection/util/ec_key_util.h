...
#ifndef updatable_private_set_intersection_UTIL_EC_KEY_UTIL_H_
#define updatable_private_set_intersection_UTIL_EC_KEY_UTIL_H_
...
#endif  // updatable_private_set_intersection_UTIL_EC_KEY_UTIL_H_
