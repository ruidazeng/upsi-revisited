...
#ifndef updatable_private_set_intersection_MESSAGE_SINK_H_
#define updatable_private_set_intersection_MESSAGE_SINK_H_
...
#endif  // updatable_private_set_intersection_MESSAGE_SINK_H_
