...
int main(int argc, char** argv) {
  ...
  auto maybe_dummy_data = updatable_private_set_intersection::GenerateRandomDatabases(
  ...
  auto server_write_status = updatable_private_set_intersection::WriteServerDatasetToFile(
  ...
  auto client_write_status = updatable_private_set_intersection::WriteClientDatasetToFile(
