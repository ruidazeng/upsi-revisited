...
#ifndef updatable_private_set_intersection_PROTOCOL_CLIENT_H_
#define updatable_private_set_intersection_PROTOCOL_CLIENT_H_
...
#endif  // updatable_private_set_intersection_PROTOCOL_CLIENT_H_
