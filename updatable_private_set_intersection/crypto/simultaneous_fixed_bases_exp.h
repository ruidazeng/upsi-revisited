...
#ifndef updatable_private_set_intersection_CRYPTO_SIMULTANEOUS_FIXED_BASES_H_
#define updatable_private_set_intersection_CRYPTO_SIMULTANEOUS_FIXED_BASES_H_
...
struct ZnContext {
  updatable_private_set_intersection::BigNum modulus;
};
...
#endif  // updatable_private_set_intersection_CRYPTO_SIMULTANEOUS_FIXED_BASES_H_
