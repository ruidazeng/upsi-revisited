...
#ifndef updatable_private_set_intersection_CRYPTO_EC_POINT_H_
#define updatable_private_set_intersection_CRYPTO_EC_POINT_H_
...
#endif  // updatable_private_set_intersection_CRYPTO_EC_POINT_H_
