...
#ifndef updatable_private_set_intersection_COMMUTATIVE_ELGAMAL_H_
#define updatable_private_set_intersection_COMMUTATIVE_ELGAMAL_H_
...
#endif  // updatable_private_set_intersection_COMMUTATIVE_ELGAMAL_H_
