...
#ifndef updatable_private_set_intersection_CRYPTO_EC_GROUP_H_
#define updatable_private_set_intersection_CRYPTO_EC_GROUP_H_
...
#endif  // updatable_private_set_intersection_CRYPTO_EC_GROUP_H_
