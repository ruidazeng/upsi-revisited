...
#ifndef updatable_private_set_intersection_EC_COMMUTATIVE_CIPHER_H_
#define updatable_private_set_intersection_EC_COMMUTATIVE_CIPHER_H_
...
//    ::updatable_private_set_intersection::StatusOr<string> double_encrypted_string =
...
//    above.
//    ::updatable_private_set_intersection::StatusOr<string> decrypted_string =
...
//    ::updatable_private_set_intersection::StatusOr<std::pair<string, string>>
...
class ECCommutativeCipher {
 public:
  ...
  static ::updatable_private_set_intersection::StatusOr<
  ...
  ::updatable_private_set_intersection::StatusOr<std::string> Encrypt(
  ...
  //
  // This method is not threadsafe.
  ::updatable_private_set_intersection::StatusOr<std::string> ReEncrypt(
  ...
  //
  // This method is not threadsafe.
  ::updatable_private_set_intersection::StatusOr<std::pair<std::string, std::string>>
  ...
  //
  // This method is not threadsafe.
  ::updatable_private_set_intersection::StatusOr<std::string> Decrypt(
      absl::string_view ciphertext);
  ...
  //
  // This method is not threadsafe.
  ::updatable_private_set_intersection::StatusOr<std::string> HashToTheCurve(
      absl::string_view plaintext);
 ...
 private:
  ...
  ::updatable_private_set_intersection::StatusOr<ECPoint> Encrypt(const ECPoint& point);

  // Hashes a string to a point on the elliptic curve.
  ::updatable_private_set_intersection::StatusOr<ECPoint> HashToTheCurveInternal(
      absl::string_view plaintext);
...
#endif  // updatable_private_set_intersection_EC_COMMUTATIVE_CIPHER_H_
