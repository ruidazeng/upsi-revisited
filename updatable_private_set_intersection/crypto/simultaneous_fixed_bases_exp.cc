...
#include "updatable_private_set_intersection/crypto/mont_mul.h"
...
template <>
StatusOr<updatable_private_set_intersection::BigNum> Clone(
    const updatable_private_set_intersection::BigNum& element) {
  return element;
}

template <>
bool IsZero(const updatable_private_set_intersection::BigNum& c) {
  return c.IsOne();
}
...
template <>
StatusOr<updatable_private_set_intersection::MontBigNum> Clone(
    const updatable_private_set_intersection::MontBigNum& element) {
  return element;
}

template <>
StatusOr<updatable_private_set_intersection::MontBigNum> Mul(
    const updatable_private_set_intersection::MontBigNum& e1,
    const updatable_private_set_intersection::MontBigNum& e2,
    const updatable_private_set_intersection::MontContext& context) {
  return e1.Mul(e2);
}

template <>
bool IsZero(const updatable_private_set_intersection::MontBigNum& c) {
...
StatusOr<Element> SimultaneousFixedBasesExp<Element, Context>::SimultaneousExp(
    const std::vector<updatable_private_set_intersection::BigNum>& exponents) const {
...
template class SimultaneousFixedBasesExp<updatable_private_set_intersection::MontBigNum,
                                         updatable_private_set_intersection::MontContext>;
