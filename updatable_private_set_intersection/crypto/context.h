...
#ifndef updatable_private_set_intersection_CRYPTO_CONTEXT_H_
#define updatable_private_set_intersection_CRYPTO_CONTEXT_H_
...
#endif  // updatable_private_set_intersection_CRYPTO_CONTEXT_H_
