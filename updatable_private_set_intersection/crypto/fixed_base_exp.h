...
#ifndef updatable_private_set_intersection_CRYPTO_FIXED_BASE_H_
#define updatable_private_set_intersection_CRYPTO_FIXED_BASE_H_
...
#endif  // updatable_private_set_intersection_CRYPTO_FIXED_BASE_H_
